...
int main(){
	...
	dGenDense = (tGenGenseG2 - tGenDenseG1) / 1000; dGenRare = (tGenRareG2 - tGenRareG1) / 1000;
	dDensePrim = (tDensePrim2 - tDensePrim1) / 1000; dDenseKruskal = (tDenseKruskal2 - tDenseKruskal1) / 1000;
	dRarePrim = (tRarePrim2 - tRarePrim1) / 1000; dRareKruskal = (tRareKruskal2 - tRareKruskal1) / 1000;
